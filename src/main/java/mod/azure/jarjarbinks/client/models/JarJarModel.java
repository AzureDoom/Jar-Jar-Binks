...
public class JarJarModel extends AnimatedTickingGeoModel<JarJarBinksEntity> {
	...
	public ResourceLocation getTextureResource(JarJarBinksEntity object) {
		return new ResourceLocation(JarJarBinksMod.MODID, "textures/entity/jarjarbinks.png");
	}
	...
	@Override
	public void setLivingAnimations(JarJarBinksEntity entity, Integer uniqueID, AnimationEvent customPredicate) {
